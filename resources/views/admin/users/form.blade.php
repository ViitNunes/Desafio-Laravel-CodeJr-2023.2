<div class="row">
    ...
    <div class="form-group col-sm-12 col-md-4">
        ...
        <input type="text" name="work_time" id="work_time" class="form-control" required value="{{ old('work_time', $user->work_time) }}">
    </div>
    <div class="form-group col-sm-12 col-md-4">
    ...
    <div class="form-group col-sm-12 col-md-4">
        ...
        <input type="text" name="office" id="office" autofocus class="form-control" required value="{{ old('office', $user->office) }}">
    </div>
    <div class="form-group col-sm-12 col-md-4">
